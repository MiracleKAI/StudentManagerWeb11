...
<script type="text/javascript">
	$(function(){
		...
		$("#submitBtn").click(function(){
			...
			$.ajax({
				...
				success: function(msg){
					...
					} else if("ZcSuccess" == msg){
						$.messager.alert("消息提醒", "注册成功", "ok");
						$("#vcodeImg").click();//切换验证码
						$("input[name='vcode']").val("");//清空验证码输入框
					} else{
						alert(msg);
		...
		$("#submitBtn2").click(function(){
			//var data = $("#form").serialize();
			<jsp:forward page="/view/login2.jsp"></jsp:forward>
...
<div class="loginWraper"style="height: auto">
  <div id="loginform" class="loginBox" style="height: auto">
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="" name="sn" type="text" placeholder="sn" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-8">
          <input id="" name="clazz_id" type="text" placeholder="班级" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-8">
          <input id="" name="sex" type="text" placeholder="性别" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright &nbsp; artisan @ 网工3班4小组 </div>
