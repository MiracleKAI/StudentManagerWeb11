		...
		if("Zc".equals(method)){
			...
			switch (type) {
				...
				case 2:{
					...
					System.out.println("name： "+name+"   pasword0:  "+password);
					boolean st= studentDao.zhuce(name, password);
					System.out.println(st+"name： "+name+"   pasword1:  "+password);
					studentDao.closeCon();
					System.out.println(st+"name： "+name+"   pasword2:  "+password);
					if(st==true)	
					loginStatus = "ScSuccess";
					break;
				}
				case 3:{
